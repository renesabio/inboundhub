...
<head>
    ...
    <title>Inbound Hub | Inteligência em Growth, CRM e RevOps</title>
...
<body class="bg-slate-50 font-sans text-slate-800">
    ...
    <header class="relative pt-24 pb-20 overflow-hidden bg-white border-b border-slate-200">
        ...
        <div class="max-w-6xl mx-auto px-4 text-center relative z-10">
            <div class="inline-flex items-center gap-2 bg-slate-100 border border-slate-200 rounded-full px-4 py-1.5 mb-8">
                <span class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                <span class="text-xs font-bold text-slate-600 uppercase tracking-widest">Atualizado para 2026</span>
            </div>
            
            <h1 class="text-4xl md:text-7xl font-black text-slate-900 font-serif mb-6 leading-tight tracking-tight">
                Chega de "Achismos".<br>
            ...
            <p class="text-xl md:text-2xl text-slate-500 max-w-3xl mx-auto font-light leading-relaxed mb-10">
                Ferramentas práticas, diagnósticos de maturidade e dossiês técnicos para quem lidera operações de Inbound, CRM e Receita.
            </p>

            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="#ferramentas" class="bg-slate-900 text-white font-bold py-4 px-8 rounded-full hover:bg-slate-800 transition shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    Acessar Ferramentas
                </a>
                <a href="participar.php" class="bg-white text-slate-900 border border-slate-300 font-bold py-4 px-8 rounded-full hover:bg-slate-50 transition">
