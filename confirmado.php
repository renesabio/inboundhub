...
<body class="bg-slate-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center py-20 px-4">
        <div class="max-w-lg w-full bg-white p-12 rounded-[2rem] shadow-2xl border border-slate-100 text-center relative overflow-hidden">
            ...
            <a href="https://chat.whatsapp.com/LfQH5QnhE8n5SV6cAn0IAS" target="_blank" class="inline-flex items-center gap-3 bg-[#25D366] text-white font-bold py-4 px-8 rounded-full hover:bg-[#128C7E] transition shadow-lg hover:shadow-green-200 transform hover:-translate-y-1 text-lg no-underline w-full justify-center">
