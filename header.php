...
<nav class="absolute md:fixed w-full z-50 top-0 transition-all duration-300 bg-white/90 backdrop-blur-md border-b border-slate-200 text-base leading-normal" id="navbar">    <div class="max-w-6xl mx-auto px-4 flex justify-between items-center h-20">
