    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden md:flex items-center space-x-8 text-sm font-semibold text-slate-600">
                ...
                <a href="index.php#comunidade" class="px-5 py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition shadow-lg shadow-indigo-200">Comunidade</a>
            </div>
        </div>
    </div>
</nav>
